...
public class SimpleFallbackSuggestionServiceTests
{
    ...
    [Fact]
    public async Task SuggestDescriptionAsync_WithChannelName_IncludesChannelInfo()
    {
        var project = new UploadProject();
        var persona = new ChannelPersona
        {
    ...
    [Fact]
    public async Task SuggestDescriptionAsync_WithTags_IncludesTags()
    {
        var project = new UploadProject();
    ...
    [Fact]
    public async Task SuggestDescriptionAsync_AlwaysIncludesAutoGeneratedHint()
    {
        var project = new UploadProject();
        var persona = new ChannelPersona();
